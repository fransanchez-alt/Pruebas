...
public class E11bLectorEscritorSeguro extends Thread {
    ...
    public static void main(String[] args) throws InterruptedException {
        List<E11bLectorEscritorSeguro> hilos = new ArrayList<>(NUM_HILOS);
        Instant inicio = Instant.now();

        for (int i = 0; i < NUM_HILOS; i++) {
            E11bLectorEscritorSeguro hilo = new E11bLectorEscritorSeguro();
            hilos.add(hilo);
            hilo.start();
        }
